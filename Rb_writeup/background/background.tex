...
\begin{figure}[h]
\begin{center}
\subfigure[]{\label{fig:edge-b}\includegraphics[height=3.5in]{figures/87levels.png}}
\hspace{-1mm}
\vspace{-2mm}
\subfigure[]{\label{fig:edge-a}\includegraphics[height=3.5in]{figures/85levels.png}}
\vspace{-2mm}
