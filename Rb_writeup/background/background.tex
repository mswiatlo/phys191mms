...
system. In that case the logic of the above discussion applies. Note also that the peak amplitude of these oscillations occurs when $\Delta\approx0$, \emph{i.e.} upon resonance.
