...
With the external magnetic field applied, laser light is used to optically pump Rb atoms into a preferential spin state.  To observe this pumping, we measure the fluorescence of pumped Rb atoms using an oscilloscope.  This sample data is shown in Fig. \ref{fig:raw_data}.
\begin{figure}[htbp]
\begin{center}
