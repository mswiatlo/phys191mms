...
\begin{figure}[h!]
\begin{center}
\subfigure[$^{85}$Rb ($F=3$ to $F=3$)]{\label{fig:edge-a}\includegraphics[height=50mm]{./figures/85raw_width.eps}}
\hspace{-1mm}
\vspace{-2mm}
\subfigure[$^{87}$Rb ($F=2$ to $F=2$)]{\label{fig:edge-b}\includegraphics[height=50mm]{./figures/87raw_width.eps}}
\vspace{-2mm}
