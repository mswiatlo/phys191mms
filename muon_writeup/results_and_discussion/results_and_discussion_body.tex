...
\begin{figure}[htbp]
\begin{center}
\subfigure[R2]{\label{fig:edge-a}\includegraphics[width=0.5\textwidth]{figures/R2.eps}}
\hspace{-7mm}
\vspace{-2mm}
\subfigure[tmu]{\label{fig:edge-b}\includegraphics[width=0.5\textwidth]{figures/tmu.eps}}
\vspace{-2mm}
\subfigure[tmu]{\label{fig:edge-c}\includegraphics[width=0.5\textwidth]{figures/tmu.eps}}
\vspace{-2mm}
\caption{test}
\label{autocorr}
\end{center}
