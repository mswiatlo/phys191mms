...
value deviates from the accepted value, $105.66$ MeV/c$^{2}$, by $14\%$.
...
Having determined the parameters for both the muon mean lifetime, $\tau_{\mu}$, and the muon mass, $m_{\mu}$ we can calculate the value for $G_{F}$ using Equation \eqref{gf}. Ultimately, from our results we calculate that $G_{F}=3.0\times 10^{-59}$ Jm$^{3}$  $\pm blah$.  This value deviates from the accepted value, $4.305\times10^{-59}$ Jm$^{3}$, by $30\%$. However our $43\%$ error includes this accepted value.
