...
The binwidths were chosen to be $200 ns$. 
...
Excluding all points prior to and including $t_{c}$, we were able to determine $\tau_{\mu}$ to be $2.12 \pm .10 \mu s$ with 95\% confidence.  This value deviates from the accepted value, $2.20\mu s$, by $3.6\%$.  However our $4.7\%$ error includes the accepted value.
...
\begin{figure}[htbp]
\begin{center}
\subfigure[muons]{\label{fig:edge-a}\includegraphics[height=52mm]{figures/Muon_Pulse_Height.eps}}
\hspace{-1mm}
\vspace{-2mm}
\subfigure[electrons]{\label{fig:edge-b}\includegraphics[height=52mm]{figures/Electron_Energy_Cutoff.eps}}
\vspace{-2mm}
\caption{test}
\label{plots}
\end{center}
