...
Excluding all points prior to and including $t_{c}$, we were able to determine $\tau_{\mu}$ to be $2.11 \pm .10 \mu s$ with 95\% confidence.  These error bars include the accepted value for $\tau_\{mu}$ ($2.20\mu s$) .  Our precent error is 
