...
A similar experimental setup (Section~\ref{instrumentation}) can be
...
the minimum stopping power, as a function of incoming momentum, of the
muon ($\langle -\frac{dE}{dx}\rangle$, approximately $2$ MeV
...
Once we establish the values of $\tao_{\mu}$ and $m_{\mu}$, we can
