...
to reduce the gradient. As a qualitative demonstation of this
...
accurate at low temperatures, and we use the relationship in Equation
...
In our experiment, the specific heat is measured under the saturated
...
where $S$ and $C$ are the entropy and specific heat per gram of the
...
the $\lambda$-point, where the superfluid fraction dissapears. In our
experiment, we measure both specific heat and second sound velocity,
so using established values for entropy (\cite{andro}), we calculate
